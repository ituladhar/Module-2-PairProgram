...
INSERT INTO reservation (site_id,name,from_date,to_date)
 VALUES ( (SELECT site_id from site WHERE site_number=623),'Wayne Family', NOW()+INTERVAL '10 days', NOW()+INTERVAL '20 days' ),
 		( (SELECT site_id from site WHERE site_number=624),'Parker Family', NOW()+INTERVAL '11 days', NOW()+INTERVAL '20 days' ),
		(  (SELECT site_id from site WHERE site_number=625),'Kent Family', NOW()+INTERVAL '12 days', NOW()+INTERVAL '20 days' );
